    ...
    function(e, t) {
        ...
        function() {
                ...
                de = function(e, t) {
                    ...
                    if (o) {
                        ...
                        var i = function() {
                            ...
                            T() && (null !== b.previousBodyPadding && (document.body.style.paddingRight = b.previousBodyPadding, b.previousBodyPadding = null),
                                function() {
                        ...
                        ee && !v(o, _.noanimation) ? o.addEventListener(ee,
                            function e() {
            ...
            var me = {
                ...
                ye = function(e) {
                    for (var t in e) be(t) || R('Unknown parameter "'.concat(t, '"')),
                        ...
                        return fe(function(e) {
                            ...
                            return s(t, e),
                                i(t, [{
                                    key: "_main",
                                    value: function(e) {
                                        return p(c(t.prototype), "_main", this).call(this, r({},
                                            n, e))
                                    }
                                }]),
                                t
            ...
            var Te = function e(t, n) {
                    ...
                    this.running = !1,
                        this.start = function() {
                            return this.running || (this.running = !0, i = new Date, o = setTimeout(t, r)),
                                r
                        },
                        this.stop = function() {
                            return this.running && (this.running = !1, clearTimeout(o), r -= new Date - i),
                                r
                        },
            ...
            var je = function(e) {
                ...
                null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n),
                    ...
                    ee && !v(n, _.noanimation) ? n.addEventListener(ee,
                        function e() {
                    ...
                    return new Promise(function(t, n) {
                        ...
                        for (var l = function(t) {
                                if (M.showLoaderOnConfirm && V.showLoading(), M.preConfirm) {
                                 ...
                                 i = j.popup.querySelectorAll("button"), r = 0; r < i.length; r++) i[r].onclick = e,
                            i[r].onmouseover = e,
                            i[r].onmouseout = e,
                            i[r].onmousedown = e;
                        ...
                        var s = function(e, t) {
                            for (var n = J(M.focusCancel), o = 0; o < n.length; o++) return (e += t) === n.length ? e = 0 : -1 === e && (e = n.length - 1),
                                n[e].focus();
                            j.popup.focus()
                        };
                        ...
                        M.toast || (le.keydownHandler = function(e) {
                            return function(e, t) {
                                if (t.stopKeydownPropagation && e.stopPropagation(), "Enter" !== e.key || e.isComposing) if ("Tab" === e.key) {
                                    for (var n = e.target,
                                             o = J(t.focusCancel), i = -1, r = 0; r < o.length; r++) if (n === o[r]) {
                                        i = r;
                                        break
                                    }
