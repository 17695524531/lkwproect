...
public interface HomePageService {
    ...
    List<Bkyxzy> getquerybkzy(Integer page, Integer limit, Object lbmc, Object zymc, Object xs);

    int getBkZykQueryCount(Object lbmc, Object zymc, Object xs);

    List<Zkuserzyk> getMyCoursedata(Integer page,Integer limit);
