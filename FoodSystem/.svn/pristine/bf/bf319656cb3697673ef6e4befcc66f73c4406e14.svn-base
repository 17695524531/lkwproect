...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/zyzqb.css"/>
                        ...
                        <i-col span="22" style="width: 100%">
                            <Card :bordered="true" dis-hover style="width: 100%;">
                                <p slot="title" style="font-weight: bold">
                                    <i class="el-icon-reading" style="color: #5FD2B5"></i>&nbsp;专起本-课程查询
                                </p>
                                <div class="car-body">
                                    <el-form :model="gqzzyform" :inline="true" ref="gqzzyform">
                                        <el-form-item label="类别" style="margin-left: 5%">
                                            <el-select v-model="gqzzyform.lb" placeholer="类别" clearable id="lb">
                                                ...
                                                <el-option v-for="b in zyfl" :value="b.zylbdm" :label="b.zylbmc"
                                                           :key="b.id"></el-option>
                                            </el-select>
                                        </el-form-item>
                                    ...
                                    <div class="btndiv" align="center">
                                        <button class="layui-btn" data-type="reload" id="querybtn"
                                                style="width: 16%;border-radius: 4px 4px 4px 4px;height: 40px;margin-top: -4px">查询
                                        </button>
                ...
                <template>
                    <Row style="padding-top: 20px;padding-left:3%;padding-right: 3%">
                        <i-col span="22" style="width: 100%">
                            <Card :bordered="true" dis-hover style="width: 100%;">
                                <p slot="title" style="font-weight: bold">
                                    <i class="el-icon-view" style="color: #5FD2B5"></i>&nbsp;专起本-课程显示
                                </p>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/zyzqbpage.js"></script>
